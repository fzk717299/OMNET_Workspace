...
fail_with_exitcode() {
	echo "30b295e01480: start"
	echo "exitCode==$1=="
	echo_common_results
	echo "30b295e01480: end"
	exit 0
}
...
echo_common_results() {
	...
	echo "execServerToken==2f96b26c-9aee-4c2b-b471-3ccbb88aeeef=="
}
...
start_server() {
	...
	VSCODE_CLI_REQUIRE_TOKEN=2f96b26c-9aee-4c2b-b471-3ccbb88aeeef "$CLI_PATH" command-shell --cli-data-dir "$VSCODE_AGENT_FOLDER/cli" --parent-process-id $$ --on-port --on-host=127.0.0.1 &> "$CLI_LOG_FILE" < /dev/null &
	CLI_PID=$!
